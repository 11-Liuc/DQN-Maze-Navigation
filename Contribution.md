...
| :--- | :--- | :--- | :--- |
| **组长 **<br>项目集成 | `requirements.txt`<br>`main.py` (入口)<br>`final_report.docx` | **3.** **系统需求与设计** | 1. **负责 GitHub 代码管理与版本控制**。<br>2. 制定代码规范，负责最终代码的合并与逻辑校验。<br>3. 汇总全组文字，完成实验报告的最终整合 。 |
| **同学 B**<br>环境工程师 | `maze_env.py` <br>`maze_maps.json`<br>`visualizer.py` | **1. 引言** <br/> | 1. 编写 5x5 迷宫环境，定义状态空间与动作空间 。<br>2. 设计奖励函数：终点 +10，碰撞 -5，步长 -0.1 。<br>3. 实现智能体移动轨迹的可视化展示 。 |
